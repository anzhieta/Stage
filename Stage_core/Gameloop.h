...
namespace stage {
	...
	/** Olio, joka suorittaa pelimoottorin pelisilmukkaa ja hoitaa pelimoottorin yleiseen ylläpitoon kuuluvia asioita.*/
	...
	private:
		...
		float timescale = 1;
		/** Pysäytetäänkö pelisilmukan suoritus tämän suorituskerran jälkeen*/
		bool abort = false;
